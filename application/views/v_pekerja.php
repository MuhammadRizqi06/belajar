        ...
        <table class="table">
            ...
            foreach ($pekerja as $pkj) : ?>
                ...
                <tr>
                    ...
                    <td><?= $pkj->alamat ?></td>
                    <td><?= $pkj->bagian ?></td>
                    <td><?= anchor('pekerja/hapus/' . $pkj->kta, '<div class="glyphicon glyphicon-trash"></div>') ?></td>
                    <td><?php echo anchor('pekerja/edit/' . $pkj->kta, '<i class="glyphicon glyphicon-edit"></i>'); ?></td>
                </tr>
            <?php endforeach; ?>
